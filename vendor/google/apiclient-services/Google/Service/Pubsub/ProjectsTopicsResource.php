 ...
 *  </code>
 */
class Google_Service_Pubsub_ProjectsTopicsResource extends Google_Service_Resource
{
  /**
   ...
   * the resource exists and does not have a policy set. (topics.getIamPolicy)
   *
